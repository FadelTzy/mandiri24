            ...
            <table id="tabel" class="table table-sm table-bordered tb-cs">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" scope="col">Rendah 1</th>
                        <th class="text-center" scope="col">Rendah 2</th>
                        <th class="text-center" scope="col">Sedang 3</th>
                        <th class="text-center" scope="col">Sedang 4</th>
                        <th class="text-center" scope="col">Sedang 5</th>
                        <th class="text-center" scope="col">Tinggi 6</th>
                        <th class="text-center" scope="col">Tinggi 7</th>
...
$(document).ready(function () {
        ...
        columns: [
            ...
            {data: 'opsi_2', name: 'opsi_2'},
            {data: 'file_2', name: 'file_2'},
            {data: 'poin_2', name: 'poin_2'},
