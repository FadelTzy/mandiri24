            ...
            <div class="card mt-3">
                <div class="card-header pb-4 pt-4 d-flex justify-content-between">
                    ...
                    <button class="btn btn-primary btn-sm mr-0 add" >
                        Tambah kategori<i class="fas fa-plus-circle pl-3" aria-hidden="true"></i></button>
                </div>
                <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title w-5" id="status">Tambah kategori</h5>
                ...
                <div class="modal-body">
                    <form id="form">
                        ...
                        <div class="row">
                            <div class="col">
                                <small class="form-text text-muted mb-1">Kode kategori</small>
                                <input type="text" name="kode_kategori" id="kode_kategori" class="form-control">
                            </div>
                            <div class="col">
                                <small class="form-text text-muted mb-1">Nama kategori</small>
...
@push('addon-script')
    ...
    $(".add").click(function() {
        ...
        $('#input').modal('show');
        $('#status').html('Tambah kategori');
        $('.save').html('Tambah kategori');
    });
