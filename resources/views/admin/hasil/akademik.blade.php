        ...
        <section class="mb-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Hasil ujian akademik</li>
                </ol>
            </nav>
        </section>
        <div class="card mb-3">
            <div class="card-header pb-1 pt-1 d-flex justify-content-end">
                <div class="d-flex">
                    <button class="btn btn-primary btn-sm mr-0 " onclick="akademik();"> <i class="fas fa-spinner"></i>
                        Proses Hasil</button>
